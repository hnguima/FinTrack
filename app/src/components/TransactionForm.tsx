                ...
                <Select
                  ...
                  onChange={(e) => {
                    ...
                    setFormData(prev => {
                      ...
                      if (newFromValue === 'external_source' && prev.to_account_id === 'external_destination') {
                        newToValue = null;
                      }
                      
                      return { ...prev, account_id: newFromValue, to_account_id: newToValue };
                    });
                  }}
                >
                  ...
                  {accounts
                    .filter(account => account.id.toString() !== formData.to_account_id)
                    .map((account) => (
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) => {
                    ...
                    setFormData(prev => {
                      ...
                      if (newToValue === 'external_destination' && prev.account_id === 'external_source') {
                        newFromValue = '';
                      }
                ...
                >
                  {formData.account_id !== 'external_source' && (
                    <MenuItem value="external_destination">External Destination</MenuItem>
                  )}
                  {accounts
