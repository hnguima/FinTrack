    ...
    transactions.forEach(transaction => {
      try {
        ...
        if (!dateStr) {
          ...
          const monthKey = `${fallbackDate.getFullYear()}-${String(fallbackDate.getMonth() + 1).padStart(2, '0')}`;
          if (!grouped[monthKey]) {
            grouped[monthKey] = [];
          }
        ...
        <Table stickyHeader>
          <TableHead>
            <TableRow>
              ...
              <TableCell sx={{ minWidth: 100, display: { xs: 'none', sm: 'table-cell' } }}>Category</TableCell>
              <TableCell sx={{ minWidth: 80, textAlign: 'right' }}>Amount</TableCell>
          ...
          <TableBody>
            {Object.keys(groupedTransactions)
              ...
              .map(monthKey => {
                const sortedTransactions = [...groupedTransactions[monthKey]]
