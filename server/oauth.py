...
def setup_oauth_handlers(google_bp, get_db_connection_func, db_path=DEFAULT_DB_PATH):
        ...
        try:
            ...
            if target_redirect == 'mobile':
                ...
                try:
                    ...
                    from crypto_utils import create_user_token
...
def get_current_user_info(get_db_connection_func, db_path=DEFAULT_DB_PATH):
